# -*- coding: utf-8 -*-
#
# boatman documentation build configuration file, created by
# sphinx-quickstart on Sun Apr 12 00:30:11 2015.
#
...
sys.path.insert(0, os.path.abspath('../boatman'))
...
htmlhelp_basename = project + u'doc'
